...
require (
	...
	github.com/openshift/api v0.0.0-20220421200455-641a165d1cca
	github.com/openshift/apiserver-library-go v0.0.0-20220421212124-5950ef701ec5
	github.com/openshift/client-go v0.0.0-20220421203740-dddeb4eb20b7
	github.com/openshift/library-go v0.0.0-20220421211142-607a089b3f0b
	...
	k8s.io/kube-aggregator v0.24.0-rc.0
