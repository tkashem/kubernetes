...
func TestValidate(t *testing.T) {
	const (
		verbWant             = "unsafe-delete-ignore-read-errors"
		auditDecisionKeyWant = "allowunsafemalformedobjectdeletion.admission.k8s.io/decision"
		auditReasonKeyWant   = "allowunsafemalformedobjectdeletion.admission.k8s.io/reason"
	)
