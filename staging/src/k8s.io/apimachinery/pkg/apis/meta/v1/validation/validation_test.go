...
func TestValidateDeleteOptionsWithIgnoreStoreReadError(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and dryRun cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and propagationPolicy cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and gracePeriodSeconds cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and preconditions cannot be both set"),
			},
		},
		{
			...
			expectedErrors: field.ErrorList{
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and dryRun cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and orphanDependents cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and gracePeriodSeconds cannot be both set"),
				field.Invalid(fieldPath, true, "ignoreStoreReadErrorWithClusterBreakingPotential and preconditions cannot be both set"),
			},
		},
